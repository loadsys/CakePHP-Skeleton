...
return [
	 ...
	 */
	'Defaults' => [
		'short_name' => '{{APP_DISPLAY_SHORT_NAME}}', //@TODO: Set the app's short name.
		'long_name' => '{{APP_NAME}}', //@TODO: Set the app's long name.
		'domain' => '{{APP_DOMAIN}}', //@TODO: Set the app's default domain name (used for email addresses and suitable for generated docs, like PDFs.)
		'meta_description' => '{{APP_META_DESCRIPTION}}', //@TODO: Set the app's default meta description.
		'meta_keywords' => '{{APP_META_KEYWORDS}}', //@TODO: Set the app's default meta keywords.
		'Env' => [
			'Token' => 'prod',
			'Hint' => [
