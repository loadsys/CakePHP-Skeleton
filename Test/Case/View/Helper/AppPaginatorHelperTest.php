...
App::uses('AppPaginatorHelper', 'View/Helper');

/**
 * AppPaginatorHelper Test Case
 *
 * @ref http://slywalker.github.io/cakephp-plugin-boost_cake/
 */
class AppPaginatorHelperTest extends CakeTestCase {
	...
	public function setUp() {
		parent::setUp();
		$View = new View();
		$this->Paginator = new AppPaginatorHelper($View);
	}
