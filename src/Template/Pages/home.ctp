...
if (!Configure::read('debug')):
    throw new NotFoundException('Default Cake homepage is suppressed when debug is off.');
endif;
...
<div class="row">
	<div class="columns large-5 platform checks">
		<?php if (version_compare(PHP_VERSION, '5.6.0', '>=')): ?>
			<p class="success">Your version of PHP is 5.6.0 or higher.</p>
		<?php else: ?>
			<p class="problem">Your version of PHP is too low. You need PHP 5.6.0 or higher to use CakePHP.</p>
		<?php endif; ?>
