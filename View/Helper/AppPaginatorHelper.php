<?php
/**
 * Application level Paginator Helper
 *
 * Extends the default Paginator to provide a Bootstrap-themed shortcut
 * method, `::pagination()`, for use with the provided `loadsys` bake
 * templates.
 */
 ...
 * @ref http://slywalker.github.io/cakephp-plugin-boost_cake/
 */
